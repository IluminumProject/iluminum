...
This mechanism has been integrated into Bitcore-Node-Iluminum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/iluminumpay/insight-api-iluminum#web-socket-api](https://github.com/iluminumpay/insight-api-iluminum#web-socket-api)
* API: [https://github.com/iluminumpay/insight-api-iluminum#instantsend-transactions](https://github.com/iluminumpay/insight-api-iluminum#instantsend-transactions)
...
By default, the Iluminum Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Iluminum Core daemon:
