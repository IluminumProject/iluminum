...
Iluminum Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Iluminum Core, where everyone uses
...
pay attention to for reviewers of Iluminum Core code.

General Iluminum Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Iluminum Core uses tinyformat, which is type safe. Leave them out to avoid confusion
