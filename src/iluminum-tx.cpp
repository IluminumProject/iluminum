...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Iluminum Core iluminum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  iluminum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded iluminum transaction") + "\n" +
              "  iluminum-tx [options] -create [commands]   " + _("Create hex-encoded iluminum transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded iluminum transaction
