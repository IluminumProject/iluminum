...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Iluminum Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  iluminum-cli [options] <command> [params]  " + _("Send command to Iluminum Core") + "\n" +
                  "  iluminum-cli [options] help                " + _("List commands") + "\n" +
                  "  iluminum-cli [options] help <command>      " + _("Get help for a command") + "\n";
