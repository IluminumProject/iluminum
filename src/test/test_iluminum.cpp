...
#define BOOST_TEST_MODULE Iluminum Test Suite

#include "test_iluminum.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_iluminum_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
