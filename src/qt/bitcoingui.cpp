    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Iluminum Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Iluminum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and iluminum: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Iluminum Core"), this);
    aboutAction->setStatusTip(tr("Show information about Iluminum Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Iluminum Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Iluminum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Iluminum addresses"));
    ...
    openAction->setStatusTip(tr("Open a iluminum: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Iluminum Core help message to get a list with possible Iluminum Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Iluminum Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Iluminum network", "", count));
    } else {
...
{
    QString strTitle = tr("Iluminum Core"); // default title
