    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ILUM-light"), QVariant("light"));
    ui->theme->addItem(QString("ILUM-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ILUM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ILUM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ILUM-traditional"), QVariant("trad"));
