 ...
 *
 *   // network
 *   CIluminumNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.iluminum.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CIluminumNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CIluminumNetwork(UniValue objIn)
    {
...
// // can be under: IluminumNetwork
// //   -- signature requirements : Key1(User)
// class CIluminumNetworkVariable : public CGovernanceObject
// {
// private:
