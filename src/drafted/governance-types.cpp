...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "IluminumNetwork") type = IluminumNetwork;
    if(strType == "IluminumNetworkVariable") type = IluminumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == IluminumNetwork) s = "IluminumNetwork";
    if(type == IluminumNetworkVariable) s = "IluminumNetworkVariable";
